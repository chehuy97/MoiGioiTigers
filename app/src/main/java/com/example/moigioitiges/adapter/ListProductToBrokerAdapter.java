...
import com.example.moigioitiges.view.broker.ProductDetailToBrokerFragment;
import com.example.moigioitiges.view.customer.ProductDetailFragment;
import com.squareup.picasso.Picasso;

import java.util.List;

public class ListProductToBrokerAdapter extends RecyclerView.Adapter<ListProductToBrokerAdapter.DataViewHolder> {
    List<ProductResponse> productResponseList;
    Context context;
    public ListProductToBrokerAdapter(List<ProductResponse> productResponseList, Context context) {
    ...
    @NonNull
    @Override
    public ListProductToBrokerAdapter.DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemview = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_product,viewGroup,false);
        return new DataViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(@NonNull final ListProductToBrokerAdapter.DataViewHolder dataViewHolder, final int i) {
        ...
        dataViewHolder.btn_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProductDetailToBrokerFragment productDetailFragment = new ProductDetailToBrokerFragment();
