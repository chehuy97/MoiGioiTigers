...
public class PayedPostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_payed_post, container, false);
        rclView =  view.findViewById(R.id.rv_listPost);
    ...
    private void loadListProduct() {
        ...
        apiService.getListProductPayed(author).enqueue(new Callback<List<ProductResponse>>() {
            @Override
